class Hero {
  ...
  public void dash() {
    if (bonusDash.dash==true && bonusDash.canDash==false && hero.jumping==false) {
    ...
    if (bonusDash.trigDash==true) {
      if (nbDashAnim<12) {
        ...
        if (lastMove==DROITE || lastMove=='A' && VIEHasBeenFalse==false) {
          heroHitboxDroite(2);
          lastMove=DROITE;
        }
        DashActivation=true;
  ...
  public void TP() {
    if (bonusTP.bonusTP==true && bonusTP.canTP==false && hero.jumping==false) {
      bonusTP.canTP=true;
    }
    ...
    if (bonusTP.trigTP==true || (TPActivationP1==true || TPActivationP2==true)) {
      resetDessin();
    }
  }
