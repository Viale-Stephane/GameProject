class Hero {
  ...
  void ArrayIndexException() {
    String[] testEnd=loadStrings("data/levels/lvlsHitbox/lvl"+levelNumber+".txt");
    if (testEnd[heroPos1].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos1].substring(3));
      nextLevel();
    } else if (testEnd[heroPos2].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos2].substring(3));
      nextLevel();
    } else if (testEnd[heroPos3].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos3].substring(3));
      nextLevel();
    } else if (testEnd[heroPos4].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos4].substring(3));
      nextLevel();
    } else if (testEnd[heroPos5].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos5].substring(3));
      nextLevel();
    } else if (testEnd[heroPos6].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos6].substring(3));
      nextLevel();
    } else if (testEnd[heroPos7].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos7].substring(3));
      nextLevel();
    } else if (testEnd[heroPos8].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos8].substring(3));
      nextLevel();
    } else if (testEnd[heroPos9].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos9].substring(3));
      nextLevel();
    } else if (testEnd[heroPos10].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos10].substring(3));
      nextLevel();
    } else if (testEnd[heroPos11].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos11].substring(3));
      nextLevel();
    } else if (testEnd[heroPos12].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos12].substring(3));
      nextLevel();
    } else if (testEnd[heroPos13].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos13].substring(3));
      nextLevel();
    } else if (testEnd[heroPos14].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos14].substring(3));
      nextLevel();
    } else if (testEnd[heroPos15].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos15].substring(3));
      nextLevel();
    } else if (testEnd[heroPos16].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos16].substring(3));
      nextLevel();
    } else if (testEnd[heroPos17].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos17].substring(3));
      nextLevel();
    } else if (testEnd[heroPos18].startsWith("end")) {
      levelNumber=Integer.parseInt(testEnd[heroPos18].substring(3));
      nextLevel();
    } else {
      VIE=false;
      nbDescente=0;
