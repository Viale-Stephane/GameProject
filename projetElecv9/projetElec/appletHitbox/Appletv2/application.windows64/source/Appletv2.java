...
public class Appletv2 extends PApplet {
...
public void hitbox() {
  ...
  if (x>=1520 && x<=1565 && y>=570 && y<=620) {
    types=end;
  }
  if(x>=1575 && x<=1620 && y>570 && y<=620){
    types="BGSwap";
  }
...
public void mouseDragged() {
  ...
  public void settings() {  size(1624, 900); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Appletv2" };
    if (passedArgs != null) {
