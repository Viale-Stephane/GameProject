class Hero {
  ...
  private int i=0, j=0, nbMontee=0, nbDescente=0, timeDeath;
  public boolean saut=false, jumping=false, droite=false, gauche=false, reset=true, firstChute=true, VIE=true, VIEHasBeenFalse=false;
