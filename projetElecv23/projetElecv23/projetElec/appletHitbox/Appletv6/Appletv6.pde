...
void hitbox() {
  ...
  if (x>=1100 && x<=1132) {
    ...
    if (y>=210 && y<=242) {
      types="wall"+noClipValue+"BottomRightCorneDarkBluer";
    }
    if (y>=250 && y<=282) {
    ...
    for (int j=0; j<38; j++) {
      ...
      if (j<37 && i<125) {
        if (type[i+128*j].startsWith("emptywallLineTopRightCorner")) {
          ...
          type[i+2+128*(j+1)]="empty";
          type[i+3+128*(j+1)]="empty";
        } else if (type[i+128*j].startsWith("emptywallBottomRightCorner")) {
          type[i+1+128*j]="empty";
          type[i+2+128*j]="empty";
          type[i+3+128*j]="empty";
          type[i+128*(j+1)]="empty";
          ...
          type[i+2+128*(j+1)]="empty";
          type[i+3+128*(j+1)]="wall";
        } else if (type[i+128*j].startsWith("emptywallNoClipBottomRightCorner")) {
          type[i+1+128*j]="empty";
          type[i+2+128*j]="empty";
          type[i+3+128*j]="empty";
          type[i+128*(j+1)]="empty";
